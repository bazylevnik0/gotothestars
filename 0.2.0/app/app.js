...
add_sprite_object( "./src/scene_nav/sprites/square-on.png"  , "square_on_jr"   , scene_nav , 0 , false ); //2
add_sprite_object( "./src/scene_nav/sprites/square-off.png" , "square_off_jr"  , scene_nav , 0 , false ); //3
add_sprite_object( "./src/scene_nav/sprites/mid.png"	    ,"mid" 	       , scene_nav , 0 , false ); //4
add_sprite_object( "./src/scene_nav/sprites/square-on.png"  , "square_on_mid"  , scene_nav , 0 , false ); //5
add_sprite_object( "./src/scene_nav/sprites/square-off.png" , "square_off_mid" , scene_nav , 0 , false ); //6
add_sprite_object( "./src/scene_nav/sprites/sr.png"	    , "sr" 	       , scene_nav , 0 , false ); //7
add_sprite_object( "./src/scene_nav/sprites/square-on.png"  , "square_on_sr"   , scene_nav , 0 , false ); //8
add_sprite_object( "./src/scene_nav/sprites/square-off.png" , "square_off_sr"  , scene_nav , 0 , false ); //9

add_gridNames( scene_nav.sprites );

scene_nav.sprites.level.scale   .set( 0.5 , 0.25 , 0.25);
scene_nav.sprites.level.position.set( 0,    0.6  , 0   );

for ( let i = 1; i < 10; i++ ) {
	scene_nav.sprites.children[i].scale.set( 0.1 , 0.1 , 0.1 );
}

scene_nav.sprites.jr		.position.set( -0.5 ,  0.1 , 0 );
scene_nav.sprites.square_on_jr  .position.set( -0.5 , -0.2 , 0 );
scene_nav.sprites.square_off_jr .position.set( -0.5 , -0.2 , 0 );
scene_nav.sprites.mid		.position.set(  0   ,  0.1 , 0 );
scene_nav.sprites.square_on_mid .position.set(  0   , -0.2 , 0 );
scene_nav.sprites.square_off_mid.position.set(  0   , -0.2 , 0 );
scene_nav.sprites.sr		.position.set(  0.5 ,  0.1 , 0 );
scene_nav.sprites.square_on_sr  .position.set(  0.5 , -0.2 , 0 );
scene_nav.sprites.square_off_sr .position.set(  0.5 , -0.2 , 0 );
...
let loading = setInterval( function () {
	if (scene_game.children[2] !== undefined) {
		...
		//scene_game
		scene_game.objects['leftbottom_Plane.004'].material.transparent = true;
		/*
